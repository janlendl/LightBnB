...
VALUES
  ...
  (4 , 'Port out', 'description' , 'https://images.pexels.com/photos/1475938/pexels-photo-1475938.jpeg?auto=compress&cs=tinysrgb&h=350', 'https://images.pexels.com/photos/1475938/pexels-photo-1475938.jpeg', 2358 , 2, 8 ,0 , 'Canada', '1392 Gaza Junction', 'Upetafpuv', 'Nova Scotia', '81059', TRUE), 
...
VALUES
  ...
  VALUES
    (2, 5, 10, 3, 'awesome'),
    (1, 4, 1, 4, 'comfortable'),
    (8, 1, 2, 4, 'very accommodating'),
    (3, 8, 5, 4, 'best place to stay'),
    (4, 2, 7, 5, 'clean rooms'),
    (4, 3, 4, 4, 'great location'),
    (5, 6, 3, 5, 'ample parking space');